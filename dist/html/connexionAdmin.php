  ...
  <body ng-app="connexionAdmin" ng-controller="connexionAdmin" class="connexion">
    ...
    <div id="formConnexion">
      ...
      <div class="form-group"> <label class="control-label">Mot de passe</label>
        <div> <input type="password" class="form-control" ng-model="password"> </div>
      </div>
      <div class="form-group"> <button name="connexion" class="btn btn-success" ng-click="boutonConnexion(email, password)">Connexion</button> <button name="oublie" class="btn btn-danger" ng-click="boutonMotDePasseOublier()">Mot de passe oublié</button> </div>
