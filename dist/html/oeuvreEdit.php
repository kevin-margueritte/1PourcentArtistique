    ...
    <div class="oeuvre edition cd-container" ng-controller="page-art">
      <nav ng-hide="hideUIAdmin" class="nav-update navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="navbar-header"> <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
          ...
          <h1 class="navbar-brand">Editeur d'oeuvre</h1> </div>
      ...
      <div ng-hide="hidePresentation" class="presentation clearfix">
        ...
        <div id="collapsePresentation" class="collapse on"> <span ng-bind-html="art.presentationHTML"></span>
          <div ng-hide=videoHide>
            <h2>Vidéo(s)</h2> <video id="vjs-big-play-centered" class="video-js vjs-default-skin vjs-big-play-centered" controls autoplay="true" muted="true" preload="auto" data-setup="{}">
					</video>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr ng-repeat="rowAuthor in authorsArray">
                    ...
                    <td> <button type="button" ng-click="removeAuthor(rowAuthor.name)" class="btn btn-removeAuthor">Supprimer</button> </td>
                  </tr>
                </tbody>
