	...
	<form method="post" class="form-horizontal center" name="form_connexion">
		...
		<div class="connexion admin">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="email" class="form-control" ng-model="email" placeholder="xxx@yyy.zzz">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label" >Mot de passe</label>
				<div class="col-sm-4">
					<input type="password" class="form-control" ng-model="password" placeholder="pErTe4(E">
				</div>
			</div>
			<div class="form-group">
	            <div class="col-sm-offset-4">
	            	<button  name="connexion" class="btn btn-success" ng-click="boutonConnexion(email, password)">Connexion</button>
	            	<button  name="oublie" class="btn btn-danger" ng-click="boutonMotDePasseOublier()">Oublie du mot de passe</button>
	            </div>
	        </div>
