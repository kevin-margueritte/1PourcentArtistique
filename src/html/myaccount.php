	...
	<form method="post" class="form-horizontal center" name="myaccount">
		...
		<div class="myaccount admin">
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="password" required class="form-control" ng-model="admin.password" placeholder="pErTe4(E">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label" >Confirmation du nouveau mot de passe</label>
				<div class="col-sm-3">
					<input type="password" required class="form-control" name="confirm_password" ng-pattern="getPattern()" ng-model="admin.password_verify" placeholder="pErTe4(E">
